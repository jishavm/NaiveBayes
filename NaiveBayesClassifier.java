...
public class NaiveBayesClassifier {
	...
	public static void calcPrior(BufferedWriter out) throws IOException {
		...
		BufferedReader br = new BufferedReader(new FileReader("train.txt")); //Opening training data for reading
		...
		while (vector != null) {
			...
			String[] trainData = vector.split("\\s+"); //Splitting the line by space
	...
	public static void calcAccuracy(BufferedWriter out) throws IOException {
		...
		while (vector != null) {
			...
			String[] predictions = vector.split("\\s+"); //Splitting the line by space
